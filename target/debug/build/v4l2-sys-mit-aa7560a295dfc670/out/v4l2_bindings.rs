...
pub const V4L2_CID_USER_BCM2835_ISP_BASE: u32 = 9968096;
pub const V4L2_CID_USER_IMX500_BASE: u32 = 9971968;
...
pub const V4L2_FOURCC_CONV: &[u8; 11usize] = b"%c%c%c%c%s\0";
...
pub const v4l2_auto_n_preset_white_balance_V4L2_WHITE_BALANCE_GREYWORLD:
    v4l2_auto_n_preset_white_balance = 10;
